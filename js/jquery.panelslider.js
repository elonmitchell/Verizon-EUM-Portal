...
(function($) {
  ...
  function _slideIn(panel, options) {
    ...
    panel.show().animate(panelAnimation, options.durationb, function() {
      _sliding = false;
  ...
  $.fn.panelslider = function(options) {
    this.click(function(e) {
      ...
      if (active.is(':visible') && panel[0] == active[0]){
                if($(".ps-active-panel").is("#overview") || $(".ps-active-panel").is("#search-details")){
          return false;
        }
